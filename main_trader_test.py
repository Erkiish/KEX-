...
data, data_unscaled = data_pipeline.get_data()
...
data_unscaled = data_unscaled[-un_resampled_data_samples:, :20, :]
...
##### Accessing unscaled data for prediction interspection #####

view_false_positives(y_pred=y_pred, 
                    y_correct=y_correct, 
                    col_y=5, 
                    n_views=3, 
                    data=data_unscaled[:, :, :10], 
                    plot_cols={5:'RSI_14', 3:'close'}
)

view_false_negatives(y_pred=y_pred, 
                    y_correct=y_correct, 
                    col_y=5, 
                    n_views=3, 
                    data=data_unscaled[:, :, :10], 
